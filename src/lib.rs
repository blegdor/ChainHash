...
#[derive(Debug)]
pub struct ChainHashProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainHashProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainHash processing");
    
    let mut processor = ChainHashProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainHashProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainHashProcessor::new(false);
